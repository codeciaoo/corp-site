...
export const services: Service[] = [
  {
    ...
    title: "ソフトウェア開発",
    description:
      "最新のテクノロジーを活用し、お客様のビジネスに最適なソフトウェアソリューションを提供します。",
    features: [
      {
        title: "Webアプリケーション開発",
        description:
          "モダンな技術スタックを使用し、スケーラブルで高性能なWebアプリケーションを開発します。",
      },
      {
        title: "モバイルアプリ開発",
        description:
          "iOSとAndroid向けのネイティブアプリケーション開発を提供します。",
      },
      {
        title: "クラウドソリューション",
        description:
          "AWSやGCP、Azureなど、主要なクラウドプラットフォームを活用したソリューションを提供します。",
      },
    ],
    process: [
      {
        ...
        title: "要件定義",
        description:
          "お客様のニーズを詳細に理解し、プロジェクトの目標と要件を明確化します。",
      },
      {
        step: 2,
        title: "設計フェーズ",
        description:
          "システム設計、UI/UX設計を行い、最適なソリューションを提案します。",
      },
      {
        step: 3,
        title: "開発",
        description:
          "アジャイル開発手法を用いて、迅速かつ柔軟に開発を進めます。",
      },
      {
        step: 4,
        title: "テストと品質保証",
  ...
  },
  {
    ...
    title: "レガシーシステムの刷新",
    description:
      "レガシーシステムの分析から、クラウド移行を含めた最適なシステム設計・開発まで提供します。",
    features: [
      {
        title: "システム分析",
      ...
      },
      {
        title: "最適化設計",
        description:
          "モダンなアーキテクチャを採用し、保守性と拡張性を向上させます。",
      },
      {
        title: "段階的移行",
        description:
          "ビジネスへの影響を最小限に抑えた段階的なシステム移行を実現します。",
      },
    ],
    process: [
      {
  ...
  },
  {
    ...
    title: "クラウドソリューション",
    description:
      "AWS、Azure、GCPなど、主要なクラウドプラットフォームを活用した最適なソリューションを提供します。",
    features: [
      {
        title: "クラウド移行",
        description:
          "オンプレミスシステムからクラウドへの最適な移行を支援します。",
      },
      {
        title: "クラウドネイティブ開発",
        description:
          "クラウドの特性を最大限に活かしたアプリケーション開発を行います。",
      },
      {
        title: "運用管理",
        description:
          "セキュリティと可用性を考慮したクラウド環境の運用管理を提供します。",
      },
    ],
    process: [
      {
  ...
  },
  {
    ...
    title: "ITコンサルティング",
    description:
      "お客様のビジネス課題をITの力で解決するための戦略立案と実行支援を提供します。",
    features: [
      {
        title: "IT戦略立案",
