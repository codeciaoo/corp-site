...
const CaseStudies = () => {
  const cases = [
    {
      ...
      description:
        "業務分析から導入まで一貫支援。結果、生産効率25%向上、在庫コスト30%削減を実現",
      path: "/case1",
    },
    {
      company: "小売業 B社",
      title: "顧客管理システムの刷新",
      description:
        "既存システムの課題分析から、クラウド移行含め新システムの構築。運用コスト40%削減",
    },
    {
      company: "サービス業 C社",
      title: "予約システムのモダナイゼーション",
      description:
        "レガシーシステムをクラウドネイティブアーキテクチャへ移行。運用効率が60%改善",
    },
    {
      company: "IT企業 D社",
      title: "社内業務システムの統合",
      description:
        "複数のシステムを統合し、業務効率化を実現。工数削減率35%を達成",
    },
    {
      company: "物流業 E社",
      title: "配送管理システムの開発",
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <h2 className="mb-12 text-center text-3xl font-bold">支援実績</h2>
