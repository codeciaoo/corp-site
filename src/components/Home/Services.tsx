import { Code, Database, Cloud, LineChart, ArrowRight } from "lucide-react";
      ...
      <div className="group relative overflow-hidden rounded-3xl bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-2xl">
        <div className="relative z-10">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-teal-600/10 text-teal-600 shadow-md">
              {icon}
            </div>
            <h3 className="pt-2 text-2xl font-bold text-gray-900">{title}</h3>
          </div>
