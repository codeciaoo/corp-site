import type { MemberPortfolio } from "../lib/types";
...
export const taharaPortfolio: MemberPortfolio = {
  ...
  // 所属組織ロゴ
  organizationLogos: [
    { src: "/images/keio.png", alt: "慶應義塾大学" },
    { src: "/images/baycurrent.png", alt: "ベイカレントコンサルティング" },
    { src: "/images/livepass.png", alt: "livepass株式会社" },
    { src: "/images/codeciao_new.png", alt: "CodeCiao株式会社" },
  ],
